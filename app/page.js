...
export default function Home() {
  ...
  const howToSteps = [
    {
      name: "Select Species",
      text: "Choose your pet (Leopard Gecko, Betta Fish, Bearded Dragon, or Ball Python) and your experience level (Beginner or Experienced)."
    },
    {
      name: "Build Setup",
      ...
      */}
      ...
      <div className="relative z-10 w-full max-w-6xl px-6 py-12 md:py-20 flex flex-col items-center">
        ...
        <div className="w-full mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 gap-4 mb-8 max-w-xl mx-auto">
