export const metadata = {
  ...
  alternates: { canonical: 'https://www.buildmyhabitat.com/guides/leopard-gecko-not-eating' },
  ...
  openGraph: {
    title: 'Leopard Gecko Not Eating - Causes & Solutions Guide',
    description: 'Complete guide to why leopard geckos stop eating and how to fix it. Learn about temperature, stress, illness, and proper care.',
    images: ['https://www.buildmyhabitat.com/gecko.jpg'],
  },
};

export default function GeckoNotEatingLayout({ children }) {
  return (
    <>
      {children}
    </>
