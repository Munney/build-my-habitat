...
// System prompt perfectly aligned with BuildMyHabitat brand
...
- Match BuildMyHabitat's tone: professional but friendly, safety-focused, educational

`;

  if (species === "leopard-gecko") {
    basePrompt += `LEOPARD GECKO KNOWLEDGE (BuildMyHabitat Standards):
...
`;
    ...
    basePrompt += `BETTA FISH KNOWLEDGE (BuildMyHabitat Standards):
...
`;
  ...
  basePrompt += `\n\nRemember: You represent BuildMyHabitat's commitment to safety, research, and education. Be helpful, accurate, and always prioritize the pet's welfare.`;
...
function getFallbackResponse(message, species, currentBuild) {
  ...
  if (lowerMessage.includes("hello") || lowerMessage.includes("hi")) {
    return "Hello! I'm your Habitat Assistant from BuildMyHabitat. I provide research-backed, science-based advice to ensure your pet thrives.\n\nWhat would you like to know about your habitat setup?";
  }
